...
@push('header')
{!! \App\Helpers\Helper::metaTags('', 0, 'innovativedesignbyjindalrail') !!}
@endpush
@section('body')
<head>
   <style>
   ...
   <main>
      <section class="about-banner">
         ...
         <div>
            <div class="container">
               <h2 class="text-white pb-2 text-center">Innovative Design by Jindal Rail</h2>
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb d-flex justify-content-center ">
                     <li class="breadcrumb-item"><a href="https://yourwebsitedemo.in/jindalrail/">Home</a></li>
                     <li class="breadcrumb-item active" aria-current="page">Innovative Design by Jindal Rail</li>
                  </ol>
               </nav>
            </div>
         </div>
