...
@push('header')
{!! \App\Helpers\Helper::metaTags('', 0, 'otherofferings') !!}
@endpush
@section('body')
<head>
   <style>
   ...
   <main>
      <section class="about-banner">
         ...
         <div>
            <div class="container">
               <h2 class="text-white pb-2 text-center">Other Offerings</h2>
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb d-flex justify-content-center ">
                     <li class="breadcrumb-item"><a href="https://yourwebsitedemo.in/jindalrail/">Home</a></li>
                     <li class="breadcrumb-item active" aria-current="page">Other Offerings</li>
                  </ol>
               </nav>
            </div>
         </div>
