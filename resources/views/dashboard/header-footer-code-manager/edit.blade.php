                        ...
                        <form action="{{ route($routePrefix . 'update', $listing->id) }}" method="POST">
                            <div class="card card-custom gutter-b card-stretch card-shadowless">
                                <div class="card-body">
                                    ...
                                    {!! \App\Helpers\Input::textAreaField('code', 'Code', TRUE, '', $listing->code) !!}
                                    {!! \App\Helpers\Input::selectField('position', 'Position', TRUE, $positions, 'select-2','id', 'name', $listing->position) !!}
                                    {!! \App\Helpers\Input::switchButton('is_active', 'Is Active', 1, TRUE, '', $listing->is_active) !!}
