                                ...
                                <div class="table-responsive">
                                    <table class="table table-vertical-center">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-muted">Compliances Type</th>
                                            <th class="text-muted">Name</th>
                                            <th class="text-muted">Published Date</th>
                                        ...
                                        @if($filter == 'all')
                                            @foreach($listings as $listing)
                                                <tr>
                                                    <td>
                                                        {{ isset($listing->year)? $years[array_search($listing->year, array_column($years, 'id'))]->name:''}}
                                                    </td>
                                                    <td>
                                                        {{ isset($listing->compliance_type)? $compliance_type[array_search($listing->compliance_type, array_column($compliance_type, 'id'))]->name:'' }}
                                                    </td>
                                                    <td>
                                                        {{ $listing->name }}
                                                    </td>
                                                    <td>
                                                        {{ date(env('DATE_FORMAT'), strtotime($listing->published_date)) }}
                                                    </td>
                                                    <td>
