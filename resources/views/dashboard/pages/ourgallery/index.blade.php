                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-vertical-center">
                                        ...
                                        <thead>
                                        <tr>
                                            <th class="text-muted">Categorty</th>
                                        ...
                                        @if($filter == 'all')
                                            @foreach($listings as $listing)
                                                <tr>
                                                    <td>
                                                        {{ isset($listing->category)? $categories[array_search($listing->category, array_column($categories, 'id'))]->name:''}}
                                                    </td>
                                                    <td>
                                                        {{ $listing->title }}
                                                    </td>
                                                    <td>
                                                        <img src="{{ asset($listing->mediaLibrary->url) }}" width="150"/>
                                                    </td>
                                                    <td>
