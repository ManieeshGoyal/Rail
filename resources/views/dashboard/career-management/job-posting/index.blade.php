                                ...
                                <div class="table-responsive">
                                    <table class="table table-vertical-center">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-muted">Posted On</th>
                                        ...
                                        @if($filter == 'all')
                                            @foreach($listings as $listing)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ \App\Helpers\Helper::truncateStringToLastPeriod(strip_tags($listing->description), 50, 20) }}
                                                    </td>
                                                    <td>
                                                        {{ date(env('DATE_FORMAT'), strtotime($listing->created_at)) }}
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('dashboard.career-management.job-posting.candidate.index', $listing->id) }}">{{ $listing->candidates ? number_format($listing->candidates->count()) : 0 }}</a>
                                                    </td>
                                                    <td>
                                        ...
                                        @else
                                            @foreach($listings as $listing)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ $listing->candidates ? number_format($listing->candidates->count()) : 0 }}
                                                    </td>
                                                    <td>
